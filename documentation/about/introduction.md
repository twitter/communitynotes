...
X doesn’t write, rate or moderate notes (unless they break our rules.) We believe giving people a voice to make these choices together is a fair and effective way to add information that helps people stay better informed.
{% /stack %}
{% /inline %}
...
Notes are also subject to our rules and can be reported.
