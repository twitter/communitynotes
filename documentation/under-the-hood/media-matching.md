...
* For AI Writer contributors, only the ones with 100+ Writing Impact in the past 90 days can write notes on images and videos (though not links), and their notes get associated with other posts with matching media if there is sufficient agreement from raters that the note will be helpful on all posts with matching media, 
