...
def meta_score(
  ...
  rules = [
    ...
    # TODO: To begin marking notes as CRH based on the EXPANSION model uncomment the two rules
    # below, modify test_meta_score to include an example triggering the EXPANSION_MODEL rule
    # and delete the current CORE_MODEL rule.
